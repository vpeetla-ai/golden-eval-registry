...
| `router_invariant` | `venkat-ai-platform`, `aegisai-enterprise-agent-platform`, `agent-finops` | ✅ VAP orchestrator map · AegisAI gateway vocab/passport · FinOps outcome KPI vocab · **Acme embed panel break tests** (`acme.embed_invariant_v1`) |
